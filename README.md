...
| Task | Model | Result |
|---|---|---|
| Clean neutrino vs. empty noise classification | AlexNet-style CNN | 1.0 accuracy |
| Noisy classification (up to 13σ noise) | Custom Mini-ResNet-18 | 98% accuracy (0-4σ noise) |
